...
public class GTCapability {
    ...
    public static final BlockCapability<ICoverableBlock, Direction> CAPABILITY_COVERABLE = BlockCapability
            .createSided(GTCEu.id("coverable"), ICoverableBlock.class);
