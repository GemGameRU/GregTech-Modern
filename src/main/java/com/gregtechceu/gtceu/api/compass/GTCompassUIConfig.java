...
public class GTCompassUIConfig implements ICompassUIConfig {
    ...
    @Getter
    private final IGuiTexture listItemSelectedBackground = ResourceBorderTexture.BUTTON_COMMON.copy()
            .setColor(0xff337f7f);
    @Getter
    ...
    private final Supplier<IGuiTexture> sectionBackground = Suppliers
            .memoize(() -> ShaderTexture.createShader(GTCEu.id("compass_background")).setUniformCache(cache -> {
                // bind uvs
